    ...
    <ul className={styleClass}>
      <li>
        {(user && user.user.is_active) &&
          <a href={user.user.storage_url} target="_blank" className="page-link" active={active}>
            My Storage
          </a>
        } 
      </li>
      ...
      <li>
        <a style={{ color: "#29DB3C" }} href="https://www.classcard.net/Login?redirect=/Main" target="_blank" className="page-link" active={active}>
          ClassCard
        </a>
      </li>
      <li>
